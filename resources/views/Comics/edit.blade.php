    ...
    <form action="{{ route('comics.update', $data->id) }}" method="POST" class="container">
        ...
        <div class="mb-3">
            ...
            <input name="title" type="text" class="form-control @error('title') is-invalid @enderror" id="title"
                aria-describedby="emailHelp" value="{{ old('title', $data->title) }}">
        ...
        <div class="mb-3">
            ...
            <textarea name="description" type="text" class="form-control" id="description">{{ old('description', $data->description ) }}</textarea>
        </div>
        ...
        <div class="mb-3">
            ...
            <input name="sale_date" type="text" class="form-control @error('sale_date') is-invalid @enderror"
                id="sale_date" value="{{ old('sale_date', $data->sale_date) }}">
            @error('sale_date')
                <div id="validationServerUsernameFeedback" class="invalid-feedback">
                    <h3>{{ $message }}</h3>
                </div>
        ...
        <div class="mb-3">
            ...
            <input name="artists[]" type="text" class="form-control @error('artists.*') is-invalid @enderror"
                id="artists" value="{{ old('artists.*', $data->artists)}}">
            @error('artists.*')
                <div id="validationServerUsernameFeedback" class="invalid-feedback">
                    <h3>{{ $message }}</h3>
                </div>
        ...
        <div class="mb-3">
            ...
            <input name="writers[]" type="text" class="form-control @error('writers.*') is-invalid @enderror"
                id="writers" value="{{ old('writers.*', $data->writers) }}">
            @error('writers.*')
                <div id="validationServerUsernameFeedback" class="invalid-feedback">
                    <h3>{{ $message }}</h3>
                </div>
